...
<section class="property-form">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="checkbox">
         <div class="box">
            <h1>please select only those which are available or near to your property than 10KM</h1>
         ...
         <div class="box">
            ...
            <p><input type="checkbox" name="Rera Certified" value="yes" />Rera Certified</p>
         </div>
      </div>
      <div class="box">
